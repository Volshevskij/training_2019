            ...
            using (SqlConnection connection = new SqlConnection(convertedConnectionString))
            {
                ...
                if (reader.HasRows)
                {
                    while (reader.Read())
                    {
                        ...
                        @event.Team1.Id = reader.GetInt32(5);
                        @event.Team1.Name = reader.GetString(6);
                        @event.Team1.Country = new Country();
                        @event.Team1.Country.Id = reader.GetInt32(7);
                        @event.Team2 = new Team();
                        @event.Team2.Id = reader.GetInt32(8);
                        @event.Team2.Name = reader.GetString(9);
                        @event.Team2.Country = new Country();
                        @event.Team2.Country.Id = reader.GetInt32(10);
                        @event.SportType = new SportType();
                        @event.SportType.Id = reader.GetInt32(11);
                        @event.SportType.Name = reader.GetString(12);
                        events.Add(@event);
                    }
                }
                reader.Close();
