...
namespace DI
{
    public class DIContainer
    {
        public static UnityContainer UpdateContainer(UnityContainer container)
        {
            ...
            container.RegisterType<IUserRepository, UserRepository>(new HierarchicalLifetimeManager(), new InjectionConstructor(container.Resolve<ISqlHelper>()));
            ...
            container.RegisterType<IUserService, UserService>(new HierarchicalLifetimeManager(), new InjectionConstructor(container.Resolve<IUserRepository>()));
