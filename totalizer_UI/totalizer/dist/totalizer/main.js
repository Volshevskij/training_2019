...
var AuthorizationComponent = /** @class */ (function () {
    function AuthorizationComponent(authService, http, formBuilder) {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.authService.userAuthentication(this.authModel.Login, this.authModel.Password).subscribe(function (data) {
...
var NavbarComComponent = /** @class */ (function () {
    function NavbarComComponent(router, userService) {
        this.router = router;
        this.userService = userService;
        this.user = 'Guest';
    }
...
var RegistrationComponent = /** @class */ (function () {
    function RegistrationComponent(formBuilder, regService) {
        this.formBuilder = formBuilder;
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                if (isMatch) {
                    ...
                    alert('Success');
                    this.regService.registerUser(this.regModel).subscribe(function (data) { return _this.sc = data; });
                }
                return [2 /*return*/];
            });
        });
    ...
    RegistrationComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"], _users_users_service__WEBPACK_IMPORTED_MODULE_3__["UsersService"]])
...
var TeamsComponent = /** @class */ (function () {
    ...
    TeamsComponent.prototype.getTeams = function () {
        var _this = this;
        this.teams = [];
        this.service.getTeams().subscribe(function (data) { return (_this.teams = data, console.log(typeof _this.teams)); });
    };
