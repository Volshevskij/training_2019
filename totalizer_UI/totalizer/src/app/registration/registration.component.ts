...
@Component({
 ...
 export class RegistrationComponent implements OnInit {
    ...
    constructor(private formBuilder: FormBuilder, public regService: UsersService, private router: Router) { }
 ...
 MustMatch(controlName: string, matchingControlName: string) {
    ...
    if (isMatch) {
      ...
      alert('Success');
      this.regService.registerUser(this.regModel).subscribe((data: any) => {
        this.sc = data;
        this.navigate();
      });
    }
